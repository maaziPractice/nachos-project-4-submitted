 ...
 */
SpaceId Exec(char *name,int charCount);
...
int CreateMV(char *,int);

int SetMV(char *,int,int);

int GetMV(char *,int);

void DeleteMV(int);

void Sprint_Syscall(unsigned int,unsigned int,int);
