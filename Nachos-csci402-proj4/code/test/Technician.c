...
/*		Wait(movieTechCVInt,movieTechLockInt);						/* Waiting for the Manager signal. */
		Wait("movieTechCV","movieTechLock");
...
/*		Broadcast(movieTheaterCVInt,movieTheaterLockInt); */
		Broadcast("movieTheaterCV","movieTheaterLock");

/*		Release(movieTheaterLockInt); */
		Release("movieTheaterLock");

/*		isMovieOver=1;												/* Setting the movie over flag. */
		SetMV("isMovieOver",0,1);
